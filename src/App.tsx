...
import HistoricoEstudiantes from '@/pages/HistoricoEstudiantes';
import RevisionNotas from '@/pages/RevisionNotas';
...
function App() {
    ...
    return (
        <BrowserRouter>
		    ...
		    <Route path="historico-estudiantes" element={<HistoricoEstudiantes />} />
		    <Route path="revision-notas" element={loggedIn ? <RevisionNotas /> : <Navigate to="login" replace />} />
                ...
                {/* ── Ruta de Histórico (TOP LEVEL, para Ctrl. de Estudios) ── */}
                <Route path="/historico-estudiantes" element={
                    loggedIn
                        ? <HistoricoEstudiantes />
                        : <Navigate to="/login" replace />
                } />
		
		 {/* ── Ruta de Revisión (TOP LEVEL, para Ctrl. de Estudios) ── */}
                <Route path="/revision-notas" element={
                    loggedIn
                        ? <RevisionNotas />
                        : <Navigate to="/login" replace />
                } />
                
		{/* ── Ruta de Configuración (TOP LEVEL) ── */}
